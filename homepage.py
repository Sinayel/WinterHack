...
acc = 78
pfp = tk.PhotoImage(file="login for app/defaultpfp.png")
...
logo = tk.PhotoImage(file="login for app/logo.png")
...
help_r = tk.Button(sidebar, text="Help", background="#ebefff", font=("Cambria", 12), activebackground="#e8ebee",
                   command=open_help)
help_r.place(relx=0.1, rely=0.7, relwidth=0.8, relheight=0.05)
...
expGraphic = tk.PhotoImage(file="login for app/exp.png")
...
lvlGraphic = tk.PhotoImage(file="login for app/lvl.png")
...
accGraphic = tk.PhotoImage(file="login for app/acc.png")
